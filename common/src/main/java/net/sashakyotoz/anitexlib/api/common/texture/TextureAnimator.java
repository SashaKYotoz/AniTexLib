...
public class TextureAnimator {
    ...
    private ResourceLocation formatResourceLocation(ResourceLocation base, int currentFrame) {
        ...
        if (matcher.matches()) {
            ...
            return ResourceLocation.fromNamespaceAndPath(base.getNamespace(), prefix + separator + targetFrame + extension);
        }
        ...
        return ResourceLocation.fromNamespaceAndPath(base.getNamespace(), cleanPath + "_" + currentFrame + (hasPng ? ".png" : ""));
    }
}